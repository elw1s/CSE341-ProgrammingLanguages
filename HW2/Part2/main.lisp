...
(defun syntax (arg-list)
    ...
    (cond
        ( (string-equal (nth 1 arg-list) "OP_PLUS")  
            (progn
                (if (not (string-equal "OP_OP" (nth 2 arg-list)))
                  (progn 
                ...
                (if (equal f_exp 0)
                    (if (not (string-equal "OP_OP" (nth 3 arg-list)))
                        (progn 
                    ...
                    (if (not (string-equal "OP_OP" (nth 6 arg-list)))
                        (progn 
        ...
        ( (string-equal (nth 1 arg-list) "KW_SET") 
          (progn
            (if (string-equal "OP_OP" (nth 3 arg-list))
               (setq b (syntax (sublist arg-list 3 (- (length arg-list) 1))))
               (setq b (nth 3 arg-list))
            )
        ...
        ( (string-equal (nth 1 arg-list) "KW_OR")  
         ...
         ( (string-equal (nth 1 arg-list) "KW_NOT")  
          ...
          ( (string-equal (nth 1 arg-list) "KW_EQUAL")  
            (progn
                (if (not (string-equal "OP_OP" (nth 2 arg-list)))
                  (progn 
                     (if (isIdentifier (nth 2 arg-list))
         ...
         ( (string-equal (nth 1 arg-list) "KW_LIST")
            (let ((temp (list)))
...
(defun getKeyword (var)
   (cond
      ...
      ((string-equal var "equal") (return-from getKeyword "KW_EQUAL"))
      ((string-equal var "less") (return-from getKeyword "KW_LESS"))
      ((string-equal var "nil") (return-from getKeyword "KW_NIL"))
      ((string-equal var "list") (return-from getKeyword "KW_LIST"))
      ((string-equal var "append") (return-from getKeyword "KW_APPEND"))
      ((string-equal var "concat") (return-from getKeyword "KW_CONCAT"))
      ((string-equal var "set") (return-from getKeyword "KW_SET"))
      ((string-equal var "deffun") (return-from getKeyword "KW_DEFFUN"))
      ((string-equal var "for") (return-from getKeyword "KW_FOR"))
...
(defun getOperator (var)
   (cond
      ...
      ((string-equal var "**") (return-from getOperator "OP_DBLMULT"))
      ((string-equal var "*") (return-from getOperator "OP_MULT"))
      ((string-equal var "(") (return-from getOperator "OP_OP"))
      ((string-equal var ")") (return-from getOperator "OP_CP"))
      ((string-equal var "\"") 
         (if (= cc 0)
            (progn
               (return-from getOperator "OP_OC")
               (setf cc 1)
            )
            (progn
               (return-from getOperator "OP_CC")
               (setf cc 0)
            )
         )
      )
