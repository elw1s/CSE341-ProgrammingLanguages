...
(defun printKeyword (var)
   (cond
      ((string-equal var "and") (print "KW_AND"))
      ((string-equal var "or") (print "KW_OR"))
      ((string-equal var "not") (print "KW_NOT"))
      ((string-equal var "equal") (print "KW_EQUAL"))
      ((string-equal var "less") (print "KW_LESS"))
      ((string-equal var "nil") (print "KW_NIL"))
      ((string-equal var "list") (print "KW_LIST"))
      ((string-equal var "append") (print "KW_APPEND"))
      ((string-equal var "concat") (print "KW_CONCAT"))
      ((string-equal var "set") (print "KW_SET"))
      ((string-equal var "deffun") (print "KW_DEFFUN"))
      ((string-equal var "for") (print "KW_FOR"))
      ((string-equal var "if") (print "KW_IF"))
      ((string-equal var "exit") (print "KW_EXIT"))
      ((string-equal var "load") (print "KW_LOAD"))
      ((string-equal var "disp") (print "KW_DISP"))
      ((string-equal var "true") (print "KW_TRUE"))
      ((string-equal var "false") (print "KW_FALSE"))
   )
)
